 ...
 * of this value object you may modify the generated sub-class of this class - JournalTypes.as.
 */
...
[ExcludeClass]
public class _Super_JournalTypes extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("JournalTypes") == null)
            {
                flash.net.registerClassAlias("JournalTypes", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _JournalTypesEntityMetadata;
    ...
    public function _Super_JournalTypes()
    {
        _model = new _JournalTypesEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _JournalTypesEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _JournalTypesEntityMetadata) : void
    {
        var oldValue : _JournalTypesEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
