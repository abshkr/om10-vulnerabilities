 ...
 * of this value object you may modify the generated sub-class of this class - OrderPsnlLookup.as.
 */
...
[ExcludeClass]
public class _Super_OrderPsnlLookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("OrderPsnlLookup") == null)
            {
                flash.net.registerClassAlias("OrderPsnlLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _OrderPsnlLookupEntityMetadata;
    ...
    public function _Super_OrderPsnlLookup()
    {
        _model = new _OrderPsnlLookupEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OrderPsnlLookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OrderPsnlLookupEntityMetadata) : void
    {
        var oldValue : _OrderPsnlLookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
