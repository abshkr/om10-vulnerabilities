...
[ExcludeClass]
internal class _EquipmentCompositionEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("etyp_isrigid", "etyp_schedul", "equip_isleaf", "eqc_count", "eqc_sub_item_path", "equipment", "sub_item_etyp_isrigid", "sub_item_sched_type", "etyp_category", "eqc_count_rt", "etyp_title_path", "ecnct_etyp", "etyp_is_drumfill", "eqc_sub_item_title", "etyp_n_items", "eqc_sub_item", "equip_list", "idx", "etyp_id_path", "eqc_sub_item_rt", "etyp_title", "etyp_class", "etyp_title_rt", "etyp_id", "cmpt_units", "etyp_id_rt", "lvl", "eqc_path", "cmptnu", "compartments", "etyp_max_gross");
    ...
    model_internal static var collectionProperties:Array = new Array("equipment", "equip_list", "compartments");
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "EquipmentComposition";
    ...
    model_internal var _eqc_countIsValid:Boolean;
    model_internal var _eqc_countValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _eqc_countIsValidCacheInitialized:Boolean = false;
    model_internal var _eqc_countValidationFailureMessages:Array;
    ...
    model_internal var _eqc_count_rtIsValid:Boolean;
    model_internal var _eqc_count_rtValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _eqc_count_rtIsValidCacheInitialized:Boolean = false;
    model_internal var _eqc_count_rtValidationFailureMessages:Array;
    ...
    model_internal var _equip_listIsValid:Boolean;
    model_internal var _equip_listValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _equip_listIsValidCacheInitialized:Boolean = false;
    model_internal var _equip_listValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_EquipmentComposition;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _EquipmentCompositionEntityMetadata(value : _Super_EquipmentComposition)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["equip_list"] = new Array();
            ...
            model_internal::collectionBaseMap["equipment"] = "valueObjects.EquipmentStructure";
            model_internal::collectionBaseMap["equip_list"] = "valueObjects.EquipmentStructure";
            model_internal::collectionBaseMap["compartments"] = "valueObjects.Compartment";
        }
        ...
        model_internal::propertyTypeMap["eqc_count"] = "Object";
        model_internal::propertyTypeMap["eqc_sub_item_path"] = "String";
        model_internal::propertyTypeMap["equipment"] = "ArrayCollection";
        model_internal::propertyTypeMap["sub_item_etyp_isrigid"] = "Object";
        model_internal::propertyTypeMap["sub_item_sched_type"] = "Object";
        model_internal::propertyTypeMap["etyp_category"] = "String";
        model_internal::propertyTypeMap["eqc_count_rt"] = "Object";
        model_internal::propertyTypeMap["etyp_title_path"] = "String";
        model_internal::propertyTypeMap["ecnct_etyp"] = "Object";
        ...
        model_internal::propertyTypeMap["equip_list"] = "ArrayCollection";
        ...
        model_internal::_eqc_countValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForEqc_count);
        model_internal::_eqc_countValidator.required = true;
        model_internal::_eqc_countValidator.requiredFieldError = "eqc_count is required";
        //model_internal::_eqc_countValidator.source = model_internal::_instance;
        //model_internal::_eqc_countValidator.property = "eqc_count";
        ...
        model_internal::_eqc_count_rtValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForEqc_count_rt);
        model_internal::_eqc_count_rtValidator.required = true;
        model_internal::_eqc_count_rtValidator.requiredFieldError = "eqc_count_rt is required";
        //model_internal::_eqc_count_rtValidator.source = model_internal::_instance;
        //model_internal::_eqc_count_rtValidator.property = "eqc_count_rt";
        ...
        model_internal::_equip_listValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForEquip_list);
        model_internal::_equip_listValidator.required = true;
        model_internal::_equip_listValidator.requiredFieldError = "equip_list is required";
        //model_internal::_equip_listValidator.source = model_internal::_instance;
        //model_internal::_equip_listValidator.property = "equip_list";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity EquipmentComposition");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity EquipmentComposition");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of EquipmentComposition");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity EquipmentComposition");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity EquipmentComposition");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isEquip_listAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnEqc_count():void
    {
        if (model_internal::_eqc_countIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfEqc_count = null;
            model_internal::calculateEqc_countIsValid();
        }
    }
    ...
    public function invalidateDependentOnEqc_count_rt():void
    {
        if (model_internal::_eqc_count_rtIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfEqc_count_rt = null;
            model_internal::calculateEqc_count_rtIsValid();
        }
    }
    ...
    public function invalidateDependentOnEquip_list():void
    {
        if (model_internal::_equip_listIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfEquip_list = null;
            model_internal::calculateEquip_listIsValid();
        }
    }
    ...
    public function get eqc_countValidator() : StyleValidator
    {
        return model_internal::_eqc_countValidator;
    }

    model_internal function set _eqc_countIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_eqc_countIsValid;         
        if (oldValue !== value)
        {
            model_internal::_eqc_countIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "eqc_countIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get eqc_countIsValid():Boolean
    {
        if (!model_internal::_eqc_countIsValidCacheInitialized)
        {
            model_internal::calculateEqc_countIsValid();
        ...
        return model_internal::_eqc_countIsValid;
    }

    model_internal function calculateEqc_countIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_eqc_countValidator.validate(model_internal::_instance.eqc_count)
        model_internal::_eqc_countIsValid_der = (valRes.results == null);
        model_internal::_eqc_countIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::eqc_countValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::eqc_countValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get eqc_countValidationFailureMessages():Array
    {
        if (model_internal::_eqc_countValidationFailureMessages == null)
            model_internal::calculateEqc_countIsValid();

        return _eqc_countValidationFailureMessages;
    }

    model_internal function set eqc_countValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_eqc_countValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_eqc_countValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "eqc_countValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    public function get eqc_count_rtValidator() : StyleValidator
    {
        return model_internal::_eqc_count_rtValidator;
    }

    model_internal function set _eqc_count_rtIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_eqc_count_rtIsValid;         
        if (oldValue !== value)
        {
            model_internal::_eqc_count_rtIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "eqc_count_rtIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get eqc_count_rtIsValid():Boolean
    {
        if (!model_internal::_eqc_count_rtIsValidCacheInitialized)
        {
            model_internal::calculateEqc_count_rtIsValid();
        ...
        return model_internal::_eqc_count_rtIsValid;
    }

    model_internal function calculateEqc_count_rtIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_eqc_count_rtValidator.validate(model_internal::_instance.eqc_count_rt)
        model_internal::_eqc_count_rtIsValid_der = (valRes.results == null);
        model_internal::_eqc_count_rtIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::eqc_count_rtValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::eqc_count_rtValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get eqc_count_rtValidationFailureMessages():Array
    {
        if (model_internal::_eqc_count_rtValidationFailureMessages == null)
            model_internal::calculateEqc_count_rtIsValid();

        return _eqc_count_rtValidationFailureMessages;
    }

    model_internal function set eqc_count_rtValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_eqc_count_rtValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_eqc_count_rtValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "eqc_count_rtValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get equip_listStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get equip_listValidator() : StyleValidator
    {
        return model_internal::_equip_listValidator;
    }

    model_internal function set _equip_listIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_equip_listIsValid;         
        if (oldValue !== value)
        {
            model_internal::_equip_listIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "equip_listIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get equip_listIsValid():Boolean
    {
        if (!model_internal::_equip_listIsValidCacheInitialized)
        {
            model_internal::calculateEquip_listIsValid();
        ...
        return model_internal::_equip_listIsValid;
    }

    model_internal function calculateEquip_listIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_equip_listValidator.validate(model_internal::_instance.equip_list)
        model_internal::_equip_listIsValid_der = (valRes.results == null);
        model_internal::_equip_listIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::equip_listValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::equip_listValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get equip_listValidationFailureMessages():Array
    {
        if (model_internal::_equip_listValidationFailureMessages == null)
            model_internal::calculateEquip_listIsValid();

        return _equip_listValidationFailureMessages;
    }

    model_internal function set equip_listValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_equip_listValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_equip_listValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "equip_listValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("eqc_count"):
            {
                return eqc_countValidationFailureMessages;
            }
            ...
            case("eqc_count_rt"):
            {
                return eqc_count_rtValidationFailureMessages;
            }
            ...
            case("equip_list"):
            {
                return equip_listValidationFailureMessages;
            }
            case("idx"):
            {
