 ...
 * of this value object you may modify the generated sub-class of this class - Drawers.as.
 */
...
[ExcludeClass]
public class _Super_Drawers extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("DrawersLookup") == null)
            {
                flash.net.registerClassAlias("DrawersLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _DrawersEntityMetadata;
    ...
    public function _Super_Drawers()
    {
        _model = new _DrawersEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DrawersEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DrawersEntityMetadata) : void
    {
        var oldValue : _DrawersEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
