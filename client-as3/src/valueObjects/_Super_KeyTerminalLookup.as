 ...
 * of this value object you may modify the generated sub-class of this class - KeyTerminalLookup.as.
 */
...
[ExcludeClass]
public class _Super_KeyTerminalLookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("KeyTerminalLookup") == null)
            {
                flash.net.registerClassAlias("KeyTerminalLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _KeyTerminalLookupEntityMetadata;
    ...
    public function _Super_KeyTerminalLookup()
    {
        _model = new _KeyTerminalLookupEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _KeyTerminalLookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _KeyTerminalLookupEntityMetadata) : void
    {
        var oldValue : _KeyTerminalLookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
