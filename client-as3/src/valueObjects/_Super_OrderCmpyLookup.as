 ...
 * of this value object you may modify the generated sub-class of this class - OrderCmpyLookup.as.
 */
...
[ExcludeClass]
public class _Super_OrderCmpyLookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("OrderCmpyLookup") == null)
            {
                flash.net.registerClassAlias("OrderCmpyLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _OrderCmpyLookupEntityMetadata;
    ...
    public function _Super_OrderCmpyLookup()
    {
        _model = new _OrderCmpyLookupEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _OrderCmpyLookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _OrderCmpyLookupEntityMetadata) : void
    {
        var oldValue : _OrderCmpyLookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
