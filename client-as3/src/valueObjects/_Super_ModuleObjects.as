 ...
 * of this value object you may modify the generated sub-class of this class - ModuleObjects.as.
 */
...
[ExcludeClass]
public class _Super_ModuleObjects extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("ModuleObjects") == null)
            {
                flash.net.registerClassAlias("ModuleObjects", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ModuleObjectsEntityMetadata;
     ...
     * properties
     */
    private var _internal_widgets : Object;
    ...
    private var _internal_object_cgi_name : Object;
    ...
    public function _Super_ModuleObjects()
    {
        _model = new _ModuleObjectsEntityMetadata(this);

        // Bind to own data or source properties for cache invalidation triggering
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "widgets", model_internal::setterListenerWidgets));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "object_cgi_name", model_internal::setterListenerObject_cgi_name));
    ...
    [Bindable(event="propertyChange")]
    public function get object_cgi_name() : Object
    {
        return _internal_object_cgi_name;
    }
    ...
    public function set widgets(value:Object) : void
    {
        var oldValue:Object = _internal_widgets;
        if (oldValue !== value)
        {
            _internal_widgets = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "widgets", oldValue, _internal_widgets));
        }
    }
    ...
    public function set object_cgi_name(value:Object) : void
    {
        var oldValue:Object = _internal_object_cgi_name;
        if (oldValue !== value)
        {
            _internal_object_cgi_name = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "object_cgi_name", oldValue, _internal_object_cgi_name));
        }
    }
    ...
    model_internal function setterListenerWidgets(value:flash.events.Event):void
    {
        _model.invalidateDependentOnWidgets();
    }
    ...
    model_internal function setterListenerObject_cgi_name(value:flash.events.Event):void
    {
        _model.invalidateDependentOnObject_cgi_name();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.widgetsIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_widgetsValidationFailureMessages);
        }
        ...
        if (!_model.object_cgi_nameIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_object_cgi_nameValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ModuleObjectsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ModuleObjectsEntityMetadata) : void
    {
        var oldValue : _ModuleObjectsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfWidgets : Array = null;
    model_internal var _doValidationLastValOfWidgets : Object;

    model_internal function _doValidationForWidgets(valueIn:Object):Array
    {
        var value : Object = valueIn as Object;

        if (model_internal::_doValidationCacheOfWidgets != null && model_internal::_doValidationLastValOfWidgets == value)
           return model_internal::_doValidationCacheOfWidgets ;

        _model.model_internal::_widgetsIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isWidgetsAvailable && _internal_widgets == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "widgets is required"));
        }

        model_internal::_doValidationCacheOfWidgets = validationFailures;
        model_internal::_doValidationLastValOfWidgets = value;
    ...
    model_internal var _doValidationCacheOfObject_cgi_name : Array = null;
    model_internal var _doValidationLastValOfObject_cgi_name : Object;

    model_internal function _doValidationForObject_cgi_name(valueIn:Object):Array
    {
        var value : Object = valueIn as Object;

        if (model_internal::_doValidationCacheOfObject_cgi_name != null && model_internal::_doValidationLastValOfObject_cgi_name == value)
           return model_internal::_doValidationCacheOfObject_cgi_name ;

        _model.model_internal::_object_cgi_nameIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isObject_cgi_nameAvailable && _internal_object_cgi_name == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "object_cgi_name is required"));
        }

        model_internal::_doValidationCacheOfObject_cgi_name = validationFailures;
        model_internal::_doValidationLastValOfObject_cgi_name = value;
