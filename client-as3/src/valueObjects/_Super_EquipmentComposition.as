 ...
 * of this value object you may modify the generated sub-class of this class - EquipmentComposition.as.
 */
...
[ExcludeClass]
public class _Super_EquipmentComposition extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("EquipmentComposition") == null)
            {
                flash.net.registerClassAlias("EquipmentComposition", cz);
            }
        }
        catch (e:Error)
        {
    ...
    {
        valueObjects.EquipmentStructure.initRemoteClassAliasSingleChild();
        valueObjects.EquipmentCompartment.initRemoteClassAliasSingleChild();
        valueObjects.Compartment.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _EquipmentCompositionEntityMetadata;
    ...
    private var _internal_eqc_count : Object;
    private var _internal_eqc_sub_item_path : String;
    private var _internal_equipment : ArrayCollection;
    model_internal var _internal_equipment_leaf:valueObjects.EquipmentStructure;
    private var _internal_sub_item_etyp_isrigid : Object;
    private var _internal_sub_item_sched_type : Object;
    private var _internal_etyp_category : String;
    private var _internal_eqc_count_rt : Object;
    private var _internal_etyp_title_path : String;
    private var _internal_ecnct_etyp : Object;
    ...
    private var _internal_equip_list : ArrayCollection;
    model_internal var _internal_equip_list_leaf:valueObjects.EquipmentStructure;
    ...
    model_internal var _internal_compartments_leaf:valueObjects.Compartment;
    ...
    public function _Super_EquipmentComposition()
    {
        _model = new _EquipmentCompositionEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "eqc_count", model_internal::setterListenerEqc_count));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "eqc_count_rt", model_internal::setterListenerEqc_count_rt));
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "equip_list", model_internal::setterListenerEquip_list));
    ...
    [Bindable(event="propertyChange")]
    public function get eqc_count() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get equipment() : ArrayCollection
    {
        return _internal_equipment;
    }

    [Bindable(event="propertyChange")]
    public function get sub_item_etyp_isrigid() : Object
    {
        return _internal_sub_item_etyp_isrigid;
    }

    [Bindable(event="propertyChange")]
    public function get sub_item_sched_type() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get eqc_count_rt() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get ecnct_etyp() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get equip_list() : ArrayCollection
    {
    ...
    public function set eqc_count(value:Object) : void
    {
        var oldValue:Object = _internal_eqc_count;
        if (oldValue !== value)
        {
    ...
    public function set equipment(value:*) : void
    {
        var oldValue:ArrayCollection = _internal_equipment;
        if (oldValue !== value)
        {
            ...
            {
                _internal_equipment = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_equipment = null;
            }
            else
            {
                throw new Error("value of equipment must be a collection");
            }
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "equipment", oldValue, _internal_equipment));
        }
    }

    public function set sub_item_etyp_isrigid(value:Object) : void
    {
        var oldValue:Object = _internal_sub_item_etyp_isrigid;
        if (oldValue !== value)
        {
    ...
    public function set sub_item_sched_type(value:Object) : void
    {
        var oldValue:Object = _internal_sub_item_sched_type;
        if (oldValue !== value)
        {
    ...
    public function set eqc_count_rt(value:Object) : void
    {
        var oldValue:Object = _internal_eqc_count_rt;
        if (oldValue !== value)
        {
    ...
    public function set ecnct_etyp(value:Object) : void
    {
        var oldValue:Object = _internal_ecnct_etyp;
        if (oldValue !== value)
        {
    ...
    public function set equip_list(value:*) : void
    {
        var oldValue:ArrayCollection = _internal_equip_list;
        if (oldValue !== value)
        {
            if (value is ArrayCollection)
            {
                _internal_equip_list = value;
            }
            else if (value is Array)
            {
                _internal_equip_list = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_equip_list = null;
            }
            else
            {
                throw new Error("value of equip_list must be a collection");
            }
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "equip_list", oldValue, _internal_equip_list));
        }
    }
    ...
    model_internal function setterListenerEqc_count(value:flash.events.Event):void
    {
        _model.invalidateDependentOnEqc_count();
    }
    ...
    model_internal function setterListenerEquipment(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            ...
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerEquipment);
            }
        }
    ...
    model_internal function setterListenerEqc_count_rt(value:flash.events.Event):void
    {
        _model.invalidateDependentOnEqc_count_rt();
    }
    ...
    model_internal function setterListenerEquip_list(value:flash.events.Event):void
    {
        if (value is mx.events.PropertyChangeEvent)
        {
            if (mx.events.PropertyChangeEvent(value).newValue)
            {
                mx.events.PropertyChangeEvent(value).newValue.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, model_internal::setterListenerEquip_list);
            }
        }
        _model.invalidateDependentOnEquip_list();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.eqc_countIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_eqc_countValidationFailureMessages);
        }
        ...
        if (!_model.eqc_count_rtIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_eqc_count_rtValidationFailureMessages);
        }
        ...
        if (!_model.equip_listIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_equip_listValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EquipmentCompositionEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EquipmentCompositionEntityMetadata) : void
    {
        var oldValue : _EquipmentCompositionEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfEqc_count : Array = null;
    model_internal var _doValidationLastValOfEqc_count : Object;

    model_internal function _doValidationForEqc_count(valueIn:Object):Array
    {
        var value : Object = valueIn as Object;

        if (model_internal::_doValidationCacheOfEqc_count != null && model_internal::_doValidationLastValOfEqc_count == value)
           return model_internal::_doValidationCacheOfEqc_count ;

        _model.model_internal::_eqc_countIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isEqc_countAvailable && _internal_eqc_count == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "eqc_count is required"));
        }

        model_internal::_doValidationCacheOfEqc_count = validationFailures;
        model_internal::_doValidationLastValOfEqc_count = value;
    ...
    model_internal var _doValidationLastValOfEquipment : ArrayCollection;
    ...
    model_internal var _doValidationLastValOfSub_item_etyp_isrigid : Object;
    ...
    model_internal var _doValidationLastValOfSub_item_sched_type : Object;
    ...
    model_internal var _doValidationCacheOfEqc_count_rt : Array = null;
    model_internal var _doValidationLastValOfEqc_count_rt : Object;

    model_internal function _doValidationForEqc_count_rt(valueIn:Object):Array
    {
        var value : Object = valueIn as Object;

        if (model_internal::_doValidationCacheOfEqc_count_rt != null && model_internal::_doValidationLastValOfEqc_count_rt == value)
           return model_internal::_doValidationCacheOfEqc_count_rt ;

        _model.model_internal::_eqc_count_rtIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isEqc_count_rtAvailable && _internal_eqc_count_rt == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "eqc_count_rt is required"));
        }

        model_internal::_doValidationCacheOfEqc_count_rt = validationFailures;
        model_internal::_doValidationLastValOfEqc_count_rt = value;
    ...
    model_internal var _doValidationLastValOfEcnct_etyp : Object;
    ...
    model_internal var _doValidationCacheOfEquip_list : Array = null;
    model_internal var _doValidationLastValOfEquip_list : ArrayCollection;

    model_internal function _doValidationForEquip_list(valueIn:Object):Array
    {
        var value : ArrayCollection = valueIn as ArrayCollection;

        if (model_internal::_doValidationCacheOfEquip_list != null && model_internal::_doValidationLastValOfEquip_list == value)
           return model_internal::_doValidationCacheOfEquip_list ;

        _model.model_internal::_equip_listIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isEquip_listAvailable && _internal_equip_list == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "equip_list is required"));
        }

        model_internal::_doValidationCacheOfEquip_list = validationFailures;
        model_internal::_doValidationLastValOfEquip_list = value;
