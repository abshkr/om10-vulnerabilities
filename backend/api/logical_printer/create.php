...
if (!isset($printer->prt_cmpy) || 
    ...
    echo json_encode(array("message" => "Unable to create logical printer. Data is incomplete."));
}

// update the printer
if ($printer->create()) {
    echo '{';
        echo '"message": "Logical printer created."';
    echo '}';
} else {
    echo '{';
        echo '"message": "Unable to create logical printer."';
    echo '}';
}
