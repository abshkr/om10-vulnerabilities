...
//     echo json_encode(array("message" => "Unable to update tanker. Data is incomplete."));
//     return;
// }

// // create the tanker
// if ($tanker->update($eqpts)){
//     echo '{';
//         echo '"message": "Tanker updated."';
//     echo '}';
// } else{
//     echo '{';
//         echo '"message": "Unable to update tanker."';
//     echo '}';
// }
