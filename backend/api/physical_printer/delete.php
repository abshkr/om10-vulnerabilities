...
if (!isset($printer->prntr) || 
    ...
    echo json_encode(array("message" => "Unable to delete physical printer. Data is incomplete."));
}

// update the printer
if ($printer->delete()) {
    echo '{';
        echo '"message": "Physical printer deleted."';
    echo '}';
} else {
    echo '{';
        echo '"message": "Unable to delete physical printer."';
    echo '}';
}
