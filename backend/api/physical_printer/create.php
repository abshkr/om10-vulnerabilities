...
if (!isset($printer->prntr) || 
    ...
    echo json_encode(array("message" => "Unable to create physical printer. Data is incomplete."));
}

// update the printer
if ($printer->create()) {
    echo '{';
        echo '"message": "Physical printer created."';
    echo '}';
} else {
    echo '{';
        echo '"message": "Unable to create physical printer."';
    echo '}';
}
