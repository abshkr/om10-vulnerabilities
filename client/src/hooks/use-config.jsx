...
const useConfig = () => {
  const [config, setConfig] = useState({
    ...
    siteTankViscosityEnabled: false,
    ...
    siteUseBaseRefCode: false,
    siteUseBaseManualFlag: false,
    siteUseLongVehicle: false,
    wriEnable: false,
    wriExpiryDays: 3,
    wriPartialMatch: false,
  ...
  useEffect(() => {
    if (features?.records && configuration?.records && environment) {
      ...
      setConfig({
        ...
        precisionViscosity: secureNumber(configurationObject?.SITE_DEFAULT_PRECISION_VISCOSITY, 5),
        ...
        siteTankViscosityEnabled: configurationObject?.SITE_TANK_VISCOSITY_ENABLED || false,
        ...
        siteListPickupLoad: configurationObject?.SITE_LIST_PICKUP_LOAD || false,
        ...
        siteUseBaseRefCode: configurationObject?.SITE_USE_BASE_REF_CODE || false,
        siteUseBaseManualFlag: configurationObject?.SITE_USE_BASE_MANUAL_FLAG || false,
        siteUseLongVehicle: configurationObject?.SITE_USE_LONG_VEHICLE || false,
        wriEnable: configurationObject?.WRI_ENABLE || false,
        wriExpiryDays: configurationObject?.WRI_EXPIRY_DAYS || 3,
        wriPartialMatch: configurationObject?.WRI_PARTIAL_MATCH || false,
