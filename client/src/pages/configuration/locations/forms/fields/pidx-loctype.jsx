...
const PidxLocationType = ({ form, value }) => {
  ...
  useEffect(() => {
    if (value) {
      setFieldsValue({
        term_pidx_locid_type: value.term_pidx_locid_type,
      });
    }
  ...
  return (
    <Form.Item
      name="term_pidx_locid_type"
      label={t('fields.termPidxLocIdType')}
...
export default PidxLocationType;
