...
const Dates = ({ form, value, expiryTypes }) => {
  ...
  useEffect(() => {
    if (value) {
      setFieldsValue({
        per_exp_d1_dmy: value.per_exp_d1_dmy === ''? null: moment(value.per_exp_d1_dmy, SETTINGS.DATE_TIME_FORMAT),
        per_exp_d2_dmy: value.per_exp_d2_dmy === ''? null: moment(value.per_exp_d2_dmy, SETTINGS.DATE_TIME_FORMAT),
        per_exp_d3_dmy: value.per_exp_d3_dmy === ''? null: moment(value.per_exp_d3_dmy, SETTINGS.DATE_TIME_FORMAT),
      });
    }
