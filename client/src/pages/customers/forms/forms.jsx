...
const FormModal = ({ value, visible, handleFormState, access, setFilterValue }) => {
  ...
  const onFinish = async () => {
    ...
    values.cust_ctgr_code = !values?.cust_ctgr_code ? '' : values?.cust_ctgr_code;
    values.cust_delv_code = !values?.cust_delv_code ? '' : values?.cust_delv_code;
    values.cust_pricetype_id = !values?.cust_pricetype_id ? '' : values?.cust_pricetype_id;
    values.cust_invtype_id = !values?.cust_invtype_id ? '' : values?.cust_invtype_id;
    values.cust_saletype_id = !values?.cust_saletype_id ? '' : values?.cust_saletype_id;
    values.cust_crd_terms = !values?.cust_crd_terms ? '' : values?.cust_crd_terms;
