      ...
      {(IS_CREATING && value.window_name === undefined) || value.window_name == 'WEEK_WINDOW' ? (
        ...
        >
          <Option key="1" value="Monday">
            {t('fields.folioPlannerWeekMon')}
          </Option>
          <Option key="2" value="Tuesday">
            {t('fields.folioPlannerWeekTue')}
          </Option>
          <Option key="3" value="Wednesday">
            {t('fields.folioPlannerWeekWed')}
          </Option>
          <Option key="4" value="Thursday">
            {t('fields.folioPlannerWeekThu')}
          </Option>
          <Option key="5" value="Friday">
            {t('fields.folioPlannerWeekFri')}
          </Option>
          <Option key="6" value="Saturday">
            {t('fields.folioPlannerWeekSat')}
          </Option>
          <Option key="7" value="Sunday">
            {t('fields.folioPlannerWeekSun')}
          </Option>
        </Select>
      ) : value.window_name == 'ONCE_WINDOW' ? (
        <div>
          {!IS_CREATING ? <Input disabled value={data.datestring} /> : <DatePicker onChange={onceChange} />}
        </div>
