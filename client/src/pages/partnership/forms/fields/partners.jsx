...
const Partner = ({ existings, company, addPartnershipCallBack }) => {
  ...
  const {
    ...
    isValidating,
    mutate: revalidate,
  } = useSWR(`${PARTNERSHIP.PARTNERS}?supplier=${company}`);
  ...
  return (
    <Form onFinish={onFinish}>
      <Form.Item name="partners" noStyle>
        <DataTable data={data} height="40vh" minimal columns={columns(t)} handleSelect={handleSelect} />
      </Form.Item>
