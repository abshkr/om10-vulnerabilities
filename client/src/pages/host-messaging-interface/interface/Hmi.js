...
class Hmi extends Component {
  ...
  manualMsg() {
    alert(
      'Manual Messaging: work in progress\n' +
  ...
  render() {
    if (this.state.logout) {
      ...
      if (process.env.REACT_APP_PROTO === 'https') {
        logoutButton = (
          <Button className="menuOption" onClick={this.logout}>
            Log out
          </Button>
        );
      }
        ...
        <div className="Hmi">
          <div>
            <div className="adjacent">
              ...
              <div>
                <div className="adjacent">
                  <Button className="menuOption" onClick={this.config}>
                    Configuration
                  </Button>
                  {/*
	...
	*/}
                  <Button className="menuOption" onClick={this.export}>
                    Export
                  </Button>
                  <Button className="menuOption" onClick={this.help}>
                    Help
                  </Button>
                  {/*
...
*/}
                ...
                <div>
                  <StatusArea statusMsg={this.state.statusMsgList} />
                </div>
              </div>
            </div>
