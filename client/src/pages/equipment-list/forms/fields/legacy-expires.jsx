...
const Dates = ({ form, value, expiryTypes }) => {
  ...
  useEffect(() => {
    if (value) {
      setFieldsValue({
        eqpt_exp_d1_dmy:
          value.eqpt_exp_d1_dmy === '' ? null : moment(value.eqpt_exp_d1_dmy, SETTINGS.DATE_TIME_FORMAT),
        eqpt_exp_d2_dmy:
          value.eqpt_exp_d2_dmy === '' ? null : moment(value.eqpt_exp_d2_dmy, SETTINGS.DATE_TIME_FORMAT),
        eqpt_exp_d3_dmy:
          value.eqpt_exp_d3_dmy === '' ? null : moment(value.eqpt_exp_d3_dmy, SETTINGS.DATE_TIME_FORMAT),
      });
    }
