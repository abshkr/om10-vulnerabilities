...
import { Form, Button, Tabs, notification, Modal, Checkbox, Input } from 'antd';
      ...
      <Tabs defaultActiveKey="1" animated={false} tabPosition="left">
        ...
        >
          <Form.Item name="M_LOADSCHEDULES" label={t('pageNames.loadSchedules')}>
            <Checkbox.Group options={loadScheduleOptions} style={{ flexDirection: 'row' }} />
          </Form.Item>
        ...
        >
          ...
          <Form.Item name="M_FOLIOMANAGEMENT" label={t('pageNames.folioSummary')}>
            <Checkbox.Group options={folioOptions} style={{ flexDirection: 'row' }} />
          </Form.Item>
