const getChildrenFromTxt = () => {
  const ctables = `ACCESS_KEYS	KYA_ALLOC_CMPY	Supplier, Carrier, Customer, Drawer
    ACCESS_KEYS	KYA_SP_SUPPLIER	Supplier
    ACCESS_KEYS	KYA_KEY_ISSUER	Issuer
    ACCESS_KEYS	KYA_DRAWER	Drawer
    ...
    ALLOC_TYPE	AT_CMPY	Supplier, Carrier, Customer, Drawer
    ...
    BA_CMPY_LNK	BACL_CMPY_CODE	Supplier
    BARMPROD	BARMPLNK_PRODCMPY	Supplier, Drawer
    BARMPROD	BARM_SUPPLIERLNK	Supplier
    BASE_PROD_OWNSHIP	SUPP_CMPY	Supplier
    BASE_TRANSLATE	BASE_TRANS_CMPY	Supplier?
    BL_HISTORY	BL_BORROWER	Supplier?
    BL_HISTORY	BL_LOANER	Supplier?
    CLOSEOUT_PRODOWNSHIP	CMPY_CODE	Supplier
    CLOSEOUT_TK_OWNER	TKCMPY_LINK	Supplier
    CMPY_CUST_PRTNR	CCP_CMPY_CODE	Supplier
    CMPY_ROLE_MSG	CRM_CMPY	Employer?
    COMPANY_RELATION	CHILD_CMPY_CODE	Carrier, Employer
    COMPANY_RELATION	PARENT_CMPY_CODE	Supplier
    CREATE_OPEN_ORDER_HOST_IN	OO_CUST_CODE	Customer
    CREATE_OPEN_ORDER_HOST_IN	OO_CARR_CODE	Carrier
    CREATE_OPEN_ORDER_HOST_IN	OO_SUPP_CODE	Supplier
    CREATE_OPEN_ORDER_HOST_IN_BAK	OO_CUST_CODE	Customer
    CREATE_OPEN_ORDER_HOST_IN_BAK	OO_CARR_CODE	Carrier
    CREATE_OPEN_ORDER_HOST_IN_BAK	OO_SUPP_CODE	Supplier
    CUST_ORDER	ORDER_CARRIER	Carrier
    CUST_ORDER	ORDER_DRAWER	Drawer
    CUSTOMER	CUST_CODE	Customer
    CUSTOMER	CUST_SUPP	Supplier
    CUSTOMER_CARRIER	CMPY_CODE	Carrier
    CUSTOMER_PRODUCT	PROD_CMPY	Supplier, Drawer
    DEL_LOAD_DETAILS	CARR_CODE	Carrier
    ...
    DOCKET	DOC_CUST	Customer
    DOCKET	DOC_SHL_SHLSSUPP	Supplier
    DOR_HISTORY	DH_SHLSSUPP	Supplier
    EPC_DATA	EPCFPROD_PRODCMPY	Supplier, Drawer
    EXPIRY_DATE_DETAILS	ED_CMPY_CODE	Carrier, Employer
    HOST_OUT_HIST	OO_CUST_CODE	Customer
    HOST_OUT_HIST	OO_CARR_CODE	Carrier
    HOST_OUT_HIST	OO_SUPP_CODE	Supplier
    HOST_OUT_INTF	OO_CUST_CODE	Customer
    HOST_OUT_INTF	OO_CARR_CODE	Carrier
    HOST_OUT_INTF	OO_SUPP_CODE	Supplier
    HOSTTMM	HOSTTMMCO	Host?
    HST_OUT_MSGS	HST_COMP_CODE	Host?
    ...
    MSG	CMPY	Employer?
    O_CLOSEOUT	OC_SUPPLIER	Supplier
    ...
    PERSONNEL	PER_CMPY	Employer
    PRDCT_MV_OWNERS	PMO_CMPNY_LNK	Supplier?
    PRFCMPT	PRFC_PRD_PRODCMPY	Supplier, Drawer
    PRICE_OFFSET	PO_SUPPLIER	Supplier
    PRICE_OFFSET	PO_PROD_PRODCMPY	Supplier, Drawer
    PRNT_VIRT_PRINT	PRNF_CMPY	Supplier, Carrier
    PRNTR_CMPY_USAGE	CMPY	Supplier
    PRODOWNSHIP_TRANSACT	SUPP_CMPY	Supplier
    PRODOWNSHIP_TRANSACT	SUPP_CMPY_TO	Supplier
    PRODUCT_MVMNTS	PMVDRPR_PRODCMPY	Supplier, Drawer
    PRODUCT_MVMNTS	PMV_SRC_COMPANY	Supplier?
    PRODUCT_MVMNTS	PMV_DST_COMPANY	Supplier?
    PRODUCT_MVMNTS	PMV_TRIP_SUPPLIE	Supplier
    PRODUCT_SWAP	PRDS_TO_CMPY	Supplier?
    PRODUCT_SWAP	PRDS_FROMCMPY	Supplier?
    PRODUCTS	PROD_CMPY	Drawer
    PRODUCTS	PROD_2ND_DRAWER	Drawer
    PROFILE	PRF_SUPP	Supplier
    ...
    SCHEDULE	SHLS_DRAWER	Drawer
    SCHEDULE	SHLS_SUPP	Supplier
    ...
    TANKERS	TNKR_OWNER	Carrier
    TANKERS	TNKR_CARRIER	Carrier
    TEMPLATE_N_CMPY	CMPY_CODE	Supplier
    TK_CLOSEOUT	TKCL_CO	Supplier
    TK_OWNERS	TKCMPY_LINK	Supplier
    TMM_FLAGS	TMMF_COMPANY	Supplier?
    TRANSFERS	TRSFPROD_PRODCMPY	Supplier, Drawer
    TRANSFERS	TRSF_SUPPLIER	Supplier
    TRANSP_EQUIP	EQPT_OWNER	Carrier`;
...
export default getChildrenFromTxt;
