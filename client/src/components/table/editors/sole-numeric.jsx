...
export default class SoleNumericEditor extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    if (data?.editable || colDef?.editable) {
  ...
  isCancelBeforeStart() {
    ...
    return this.cancelBeforeStart || (data?.editable !== undefined && !(data?.editable || colDef?.editable));
  }
