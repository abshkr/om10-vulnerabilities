...
export const CREATE = '/api/pages/gate_permission/create.php';
export const UPDATE = '/api/pages/gate_permission/update.php';
export const DELETE = '/api/pages/gate_permission/delete.php';

export const DELETE_RULE = '/api/pages/gate_permission/delete_rule.php';
