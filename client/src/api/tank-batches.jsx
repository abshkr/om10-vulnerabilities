...
export const CREATE = '/api/pages/tank_batch/create.php';
export const UPDATE = '/api/pages/tank_batch/update.php';
export const DELETE = '/api/pages/tank_batch/delete.php';
