...
export const READ_TEMPLATE = '/api/pages/address/read_template.php';

export const CREATE = '/api/pages/address/create.php';
export const UPDATE = '/api/pages/address/update.php';
export const DELETE = '/api/pages/address/delete.php';
export const UPDATE_TEMPLATE = '/api/pages/address/update_template.php';
