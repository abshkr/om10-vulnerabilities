...
export const TYPES = '/api/pages/report_profile/report_profile_types.php';
...
export const CLOSEOUT_JOBS = '/api/pages/report_profile/closeout_jobs.php';
export const SUPPLIERS = '/api/pages/report_profile/suppliers.php';
