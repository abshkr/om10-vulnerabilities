...
export const ALT_UNITS = '/api/pages/movement/alternate_units.php';
export const ARMS = '/api/pages/manual_trans/get_arms.php';
...
export const SUBMIT = '/api/pages/movement/submit.php';
