...
class TankService
{
   ...
   public function getPaged($values, $dtypes, $sorts, $orders, $pageNum = 1, $pageSize = 50)
	...
	public function lookupTankStatusTypes($caseType='L')
	{
        $sql = "
			select 
				TANK_STATUS_ID
...
*/	
    public function updateTankStatus($data)
	{
        ...
        ***************************************************************************************************/
		...
		// update Tank Status and Alarm Levels
		$this->updateConfigTankColumn($data->tank_terminal, $data->tank_code, $data->tank_status, "tank_status");
		$this->updateConfigTankColumn($data->tank_terminal, $data->tank_code, $data->tank_hh_level, "tank_hh_level");
		$this->updateConfigTankColumn($data->tank_terminal, $data->tank_code, $data->tank_h_level, "tank_h_level");
		$this->updateConfigTankColumn($data->tank_terminal, $data->tank_code, $data->tank_l_level, "tank_l_level");
		$this->updateConfigTankColumn($data->tank_terminal, $data->tank_code, $data->tank_ll_level, "tank_ll_level");
		$this->updateConfigTankColumn($data->tank_terminal, $data->tank_code, $data->tank_uh_level, "tank_uh_level");
		$this->updateConfigTankColumn($data->tank_terminal, $data->tank_code, $data->tank_ul_level, "tank_ul_level");
		//////////////////////////////////////////////////////////////////////////////////////////////////////////
		////////////////////// new module to log any changes of any fields on any screen ////////////////////////
		////////////////////// After the updates                                         ////////////////////////
		/////////////////////////////////////////////////////////////////////////////////////////////////////////
