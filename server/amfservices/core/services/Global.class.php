...
if(!defined('GLOBALCLASS')) define('GLOBALCLASS','[AMF]-Global.class');
...
/**
* change the keys of an array to lower case or upper case according to the flag
* @param $data an array whose keys to be converted.
* @param $type L: lower case; U or else: upper case
* @retval: an array
*/
function convertKeyCase($data, $type)
{
	$arr = array();
