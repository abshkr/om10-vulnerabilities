...
if (!defined('MANUAL_TRANSACTION')) {
    define('MANUAL_TRANSACTION', basename(__FILE__));
}
...
class ManualTransactions
{
    ...
    private function populate_auth_req($number_entered, $trans, $is_nomination = 0, $trans_id = 0)
    {
        ...
        if ($is_nomination == 0) { /* For open order, use populate_openorder_personkey_info which */
    ...
    public function do_nomination($mv_item_id,
        $para_trans,
        $num_of_transfers,
        $transfers,
        $from = null,
    ...
    public function do_monination_item($nomi_id, $para_trans, $num_of_transfers, $transfers)
    {
    ...
    public function do_create($order_number,
        $para_trans,
        $num_of_transfers,
        $transfers,
        $is_nomination = 0,
        ...
        logMe(sprintf("%s::%s START.", __CLASS__, __FUNCTION__), MANUAL_TRANSACTION);
        logMe(json_encode($para_trans), MANUAL_TRANSACTION);
    ...
    public function do_mv_schd($mlitm_id, $per_code, $tank_code, $schd_qty, $drawer1, $prod1, $drawer2, $prod2)
    {
    ...
    public function do_special($mlitm_id)
    {
    ...
    public function do_reverse($trip_id, $supplier)
    {
