...
if (!defined('GLOBALCLASS')) {
    define('GLOBALCLASS', 'Global.class');
}
...
if (!defined('DBERRORLOG')) {
    define('DBERRORLOG', $GLOBALS['LOGDIR'] . $GLOBALS['SEPARATOR'] . 'db_error.log');
}

/* define debug log file                                                      */
if (!defined('TLOG')) {
    define('TLOG', $GLOBALS['LOGDIR'] . $GLOBALS['SEPARATOR'] . 'debug.log');
}

/* define user error log file                                                 */
if (!defined('ERRORLOG')) {
    define('ERRORLOG', $GLOBALS['LOGDIR'] . $GLOBALS['SEPARATOR'] . 'error.log');
}
