...
if (API_F == "YES")
{
    ...
    {                  
        ...
        public function __toString()
        {
            ...
            for ($j = 0; $j < $this->Number_of_Meters; ++$j)
            {
                $msg_string = $msg_string . 
                    $this->mtr_det[$j]->Injector_or_Meter . 
                    $this->mtr_det[$j]->Meter_Injector_Code .
                    $this->mtr_det[$j]->pd->is_base_product . 
                    $this->mtr_det[$j]->pd->drawer_code . 
                    $this->mtr_det[$j]->pd->product_code .
                    $this->mtr_det[$j]->prod_class->prod_class . 
                    $this->mtr_det[$j]->prod_class->dens . 
                    $this->mtr_det[$j]->prod_class->mass_fract .
                    $this->mtr_det[$j]->prod_class->exp_coeff . 
                    $this->mtr_det[$j]->temps->Temperature . 
                    $this->mtr_det[$j]->temps->Average_Temperature .
                    $this->mtr_det[$j]->asmx->amb_vol . 
                    $this->mtr_det[$j]->asmx->cor_vol . 
                    $this->mtr_det[$j]->asmx->liq_kg .
                    $this->mtr_det[$j]->asm2->amb_vol . 
                    $this->mtr_det[$j]->asm2->cor_vol . 
                    $this->mtr_det[$j]->asm2->liq_kg .
                    $this->mtr_det[$j]->asm3->amb_vol . 
                    $this->mtr_det[$j]->asm3->cor_vol . 
                    $this->mtr_det[$j]->asm3->liq_kg .
                    $this->mtr_det[$j]->Start_Mass . 
                    $this->mtr_det[$j]->End_Mass;
            }
...
class ManualTransactions
{
    ...
    {
        logMe("do_nomination", Manual_TRANSACTION);
        $trans_id = $this->get_trnsid();
