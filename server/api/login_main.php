...
$authdata = json_decode(file_get_contents("php://input"));
if ($authdata) {
...
$authmode = "DEFAULT";
if (isset($authobj->authmode)) {
    $authmode = $authobj->authmode;
}

if ($authmode === "LDAP") {
    // echo __DIR__ . '/login_ldap.php';
    include_once __DIR__ . '/login_ldap.php';
} elseif ($authmode === "SAML") {
    // echo __DIR__ . '/login_saml.php';
    include_once __DIR__ . '/login_saml.php';
} else {
    // echo __DIR__ . '/login_default.php';
