/*
    Add the following new column in table TRANSP_EQUIP for the feature of Cross Over Protection at a terminal:
    EQPT_GUARD_MASTER_ID: 
        The Guardmaster Equipment ID field is alphanumeric text with max length 10.    
        This new field need to be enabled only when Guardmaster flag is turned on for a piece of Equipment
*/

alter table TRANSP_EQUIP add EQPT_GUARD_MASTER_ID VARCHAR2(10);
