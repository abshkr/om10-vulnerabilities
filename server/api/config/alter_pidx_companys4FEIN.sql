/*
    Add the following new columns in table COMPANYS for the feature of Petroleum Industry Data eXchange (PIDX) standards at a terminal:

    CMPY_PIDX_FEIN:         Federal Employer Identification Number, 9 digits
    CMPY_PIDX_SSN:          Social Security Number, 9 digits
    CMPY_PIDX_CARRIER_FEIN: Carrier FEIN, 10 Alphanumeric characters, 9 digit FEIN + F/S/U 

    The rules to make Carrier FEIN:
        When FEIN has value 123456789, Carrier FEIN = FEIN number + 'F' = '123456789F'
        When FEIN has no value, 
            When "Social Security Number" has value 987654321, Carrier FEIN = SSN number + 'S' = '987654321S'
            When "Social Security Number" has no value, Carrier FEIN = '000000000U'
*/

alter table COMPANYS add CMPY_PIDX_FEIN VARCHAR2(9);
alter table COMPANYS add CMPY_PIDX_SSN VARCHAR2(9);
alter table COMPANYS add CMPY_PIDX_CARRIER_FEIN VARCHAR2(10);



CREATE OR REPLACE FORCE VIEW GUI_COMPANYS
(
    CMPY_CODE,
    CMPY_NAME,
    CMPY_TYPE,
