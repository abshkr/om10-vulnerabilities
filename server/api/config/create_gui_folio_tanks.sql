CREATE OR REPLACE FORCE VIEW GUI_FOLIO_TANKS AS 
select
    tnk.TANK_CODE
    , tnk.TANK_NAME
    , tnk.TANK_TERMINAL
    , trm.TERM_NAME                        as TANK_SITENAME
    , NVL(ftk.TANK_BASECODE, tnk.TANK_BASE)   as TANK_BASE
    ...
    , tnk.TANK_DENS_MODE
    , ftk.CLOSEOUT_NR
    , ftk.BASE_PERIOD_INDEX
    , ftk.BASE_PERIOD_OPEN
    , ftk.BASE_PERIOD_CLOSE
    , ftk.OPEN_STD_TOT
    , ftk.OPEN_MASS_TOT
    , ftk.LAST_GAUGE_TIME
    , ftk.CLOSE_STD_TOT
    ...
    , ftk.CLOSE_AMB_TOT
    , ftk.FREEZE_AMB_TOT
    , ftk.TANK_LEVEL               as HIST_TANK_LEVEL      
    , ftk.TANK_WATER_LVL           as HIST_TANK_WATER_LVL
    , ftk.TANK_WATER               as HIST_TANK_WATER
    , ftk.TANK_ROOF_WEIGHT         as HIST_TANK_ROOF_WEIGHT
    , ftk.TANK_IFC                 as HIST_TANK_IFC
from
    TANKS                                  tnk
    , (
...
where
    ...
    and tnk.TANK_TERMINAL = ftk.TANK_TERMINAL
    and tnk.TANK_CODE = ftk.TANK_CODE
    and NVL(ftk.TANK_BASECODE, tnk.TANK_BASE) = bsp.BASE_CODE
