/*
    Add the following new columns in table BASE_PRODS for the feature of Petroleum Industry Data eXchange (PIDX) standards at a terminal:

    BASE_PIDX_CODE:    12 Alphanumeric long
                       A code which identifies the base product loaded. 
...
alter table BASE_PRODS add BASE_PIDX_CODE VARCHAR2(12);
