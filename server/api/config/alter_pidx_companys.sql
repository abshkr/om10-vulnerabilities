/*
    ...
    CMPY_PIDX_CARRIER:  Standard Carrier Alpha Code, Alpha-numeric field (12 characters)  
                        containing the Standard Carrier Alpha Code (SCAC) to identify the carrier. 
                        The SCAC codes are maintained and distributed by the National Motor Freight Traffic Association as Continental Directory NMF101.
    CMPY_PIDX_SUPPLIER: Seller ID, 3 Alphanumeric
    CMPY_PIDX_DRAWER:   Final Shipper ID, 3 Alphanumeric
    CMPY_PIDX_CUSTOMER: Consignee Number, 14 Alphanumeric
*/

alter table COMPANYS add CMPY_PIDX_CARRIER VARCHAR2(12);
alter table COMPANYS add CMPY_PIDX_SUPPLIER VARCHAR2(3);
alter table COMPANYS add CMPY_PIDX_DRAWER VARCHAR2(3);
alter table COMPANYS add CMPY_PIDX_CUSTOMER VARCHAR2(14);
