...
alter table ALLOC_DETAILS add ALL_INDEX NUMBER(4) DEFAULT 0 NOT NULL;
alter table ADJUSTS add ADJALL_ALL_INDEX NUMBER(4) DEFAULT 0 NOT NULL;
alter table ACCESS_KEYS add KYA_ALLOC_INDEX NUMBER(4);


alter table ALL_CHILD add ALCH_ALP_ALL_INDEX NUMBER(4) DEFAULT 0 NOT NULL;
alter table ALLOCS add ALL_INDEX NUMBER(4) DEFAULT 0 NOT NULL;
alter table LOCKAL add LOCKAL_INDEX NUMBER(4) DEFAULT 0 NOT NULL;
...
ALTER TABLE ALL_CHILD
ADD CONSTRAINT FK_ALL_CHILD_PROD FOREIGN KEY (ALCH_ALP_ALL_INDEX, ALCH_ALP_ALL_ATKY_AT_TYPE, ALCH_ALP_ALL_ATKY_AT_CMPY, ALCH_ALP_ALL_PROD_PRODCODE, ALCH_ALP_ALL_PROD_PRODCMPY)
REFERENCES ALLOCS (ALL_INDEX, ALL_ATKY_AT_TYPE, ALL_ATKY_AT_CMPY, ALL_PROD_PRODCODE, ALL_PROD_PRODCMPY);


ALTER TABLE ALLOC_DETAILS
ADD CONSTRAINT FK_ALLOC_DETAILS_PROD FOREIGN KEY (ALL_INDEX, ALL_ATKY_AT_TYPE, ALL_ATKY_AT_CMPY, ALL_PROD_PRODCODE, ALL_PROD_PRODCMPY)
REFERENCES ALLOCS (ALL_INDEX, ALL_ATKY_AT_TYPE, ALL_ATKY_AT_CMPY, ALL_PROD_PRODCODE, ALL_PROD_PRODCMPY);
...
ALTER TABLE ADJUSTS
ADD CONSTRAINT FK_ADJUST_ALLOC FOREIGN KEY (ADJALL_ALL_INDEX, ADJALL_ALL_ATKY_AT_TYPE, ADJALL_ALL_ATKY_AT_CMPY, ADJALL_ALL_PROD_PRODCODE, ADJALL_ALL_PROD_PRODCMPY)
REFERENCES ALLOCS (ALL_INDEX, ALL_ATKY_AT_TYPE, ALL_ATKY_AT_CMPY, ALL_PROD_PRODCODE, ALL_PROD_PRODCMPY);


ALTER TABLE ACCESS_KEYS
ADD CONSTRAINT FK_ACCESS_KEY_ALLOC FOREIGN KEY (KYA_ALLOC_INDEX, KYA_ALLOC_TYPE, KYA_ALLOC_CMPY, KYA_SP_SUPPLIER)
REFERENCES LOCKAL (LOCKAL_INDEX, LOCKATYP_AT_TYPE, LOCKATYP_AT_CMPY, LOCKAL_SUPL);
...
ALTER TABLE LOCKAL
ADD CONSTRAINT PK_LOCKAL PRIMARY KEY (LOCKATYP_AT_TYPE, LOCKATYP_AT_CMPY, LOCKAL_SUPL, LOCKAL_LOCK);
-- ADD CONSTRAINT PK_LOCKAL PRIMARY KEY (LOCKATYP_AT_TYPE, LOCKATYP_AT_CMPY, LOCKAL_SUPL);


-- change primary key in table ALLOCS to enable multiple allocations for each company and allocation type

alter table ALLOCS add ALL_LOCK NUMBER(2);

ALTER TABLE ALLOCS
DROP CONSTRAINT PK_ALLOCS;

ALTER TABLE ALLOCS
ADD CONSTRAINT PK_ALLOCS PRIMARY KEY (ALL_ATKY_AT_TYPE, ALL_ATKY_AT_CMPY, ALL_PROD_PRODCODE, ALL_PROD_PRODCMPY, ALL_LOCK);
-- ADD CONSTRAINT PK_ALLOCS PRIMARY KEY (ALL_ATKY_AT_TYPE, ALL_ATKY_AT_CMPY, ALL_PROD_PRODCODE, ALL_PROD_PRODCMPY);


-- change primary key in table ALL_CHILD to enable multiple allocations for each company and allocation type

alter table ALL_CHILD add ALCH_ALP_ALL_LOCK NUMBER(2);

ALTER TABLE ALL_CHILD
DROP CONSTRAINT PK_ALL_CHILD;

ALTER TABLE ALL_CHILD
ADD CONSTRAINT PK_ALL_CHILD PRIMARY KEY (ALCH_ALP_ALL_ATKY_AT_TYPE, ALCH_ALP_ALL_ATKY_AT_CMPY, ALCH_ALP_ALL_PROD_PRODCODE, ALCH_ALP_ALL_PROD_PRODCMPY, ALCH_ALP_ALL_LOCK, ALL_CHILD_P_NO);
-- ADD CONSTRAINT PK_ALL_CHILD PRIMARY KEY (ALCH_ALP_ALL_ATKY_AT_TYPE, ALCH_ALP_ALL_ATKY_AT_CMPY, ALCH_ALP_ALL_PROD_PRODCODE, ALCH_ALP_ALL_PROD_PRODCMPY, ALL_CHILD_P_NO);
...
select
    aitem.ALL_INDEX                 as AITEM_INDEX
...
select
    aiprd.ALCH_ALP_ALL_INDEX                as AIPRD_SEQ
...
--      or (aiprd.ALCH_ALP_ALL_ATKY_AT_TYPE=1 and acmpy.CMPY_CODE = SYS_CONTEXT('CONN_CONTEXT', 'CMPYCODE'))) )
    ...
    and alloc.LOCKAL_LOCK = ltype.ALLOC_LOCK_ID
    and aiprd.ALCH_ALP_ALL_INDEX = alloc.LOCKAL_INDEX
/
