/*
    Add new column TANK_FLOW_RATE to store the current flow rate of tank's product receipt or disposal.
    > 0: recipt
    < 0: disposal
*/
alter table TANKS add TANK_FLOW_RATE FLOAT;
