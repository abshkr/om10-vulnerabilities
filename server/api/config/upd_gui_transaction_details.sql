ALTER TABLE TRANSFERS ADD TRSF_VCF FLOAT;
ALTER TABLE TRANBASE ADD TRSB_VCF FLOAT;

UPDATE TRANBASE 
SET TRSB_VCF = TRSB_CVL / TRSB_AVL
WHERE TRSB_AVL > 0; -- AND TRSB_VCF IS NULL;

UPDATE TRANSFERS 
SET TRSF_VCF = TRSF_QTY_COR / TRSF_QTY_AMB
WHERE TRSF_QTY_AMB > 0; -- AND TRSF_VCF IS NULL;
