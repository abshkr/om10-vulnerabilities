...
class IDAssignment 
{
    ...
    function tanker_count($tnkr_owner)
    {
        Utilities::sanitize($this);
    ...
    function schedulables_count($owner)
    {
        Utilities::sanitize($this);
    ...
    function non_schedulables_count($owner)
    {
        Utilities::sanitize($this);
    ...
    function searchCount($tanker, $personnel, $tag)
    {
        Utilities::sanitize($this);
    ...
    function lookupPsnCount($employer, $role)
    {
        Utilities::sanitize($this);
    ...
    function search($tanker, $personnel, $tag)
    {
        if (!isset($this->end_num)) {
            $this->start_num = 1;
