    ...
    public function start_folio()
    {
        $query = "
            SELECT CLOSEOUT_NR, 
                ...
                ROUND(PMV_OPEN_KG, 0) PMV_OPEN_KG,
    ...
    public function is_bay_loaded()
    {
        ...
        $query = "
            ...
            WHERE TRSB_ID_TRSF_ID = TRSF_ID AND TRSB_ID_TRSF_TRM = TRSF_TERMINAL
                AND TRSFTRID_TRSA_ID = TRSA_ID AND TRSFTRID_TRSA_TRM = TRSA_TERMINAL
                AND PMV_NUMBER = :pmv_number
                AND (TRSA_ED_DMY > NVL(PMV_DATE1, SYSDATE) AND TRSA_ED_DMY < NVL(PMV_DATE2, SYSDATE))
                AND (TRSB_TK_TANKCODE = PMV_SRCCODE OR TRSB_TK_TANKCODE = PMV_DSTCODE)
            GROUP BY TRSB_TK_TANKCODE
        ";
        $stmt = oci_parse($this->conn, $query);
    ...
    public function end_folio()
    {
        $query = "
            SELECT CLOSEOUT_NR, 
                ...
                ROUND(DECODE(PMV_STATUS, 3, PMV_CLOSE_KG, TANK_LIQUID_KG), 0) PMV_CLOSE_KG,
