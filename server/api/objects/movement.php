...
class Movement extends CommonClass
{
    ...
    */
    ...
    public function pagination_count()
    {
        ...
        if (!isset($this->mv_number) || $this->mv_number == '') {
            $this->mv_number = "-1";
        }
        if (!isset($this->mv_status) || $this->mv_status == '') {
            $this->mv_status = -1;
        }
        if (!isset($this->mv_srctype) || $this->mv_srctype == '') {
            $this->mv_srctype = -1;
        }
        if (!isset($this->mv_terminal) || $this->mv_terminal == '') {
            $this->mv_terminal = "-1";
        }
        ...
        // if (!isset($this->use_range) || $this->use_range == 'N') {
        //     $this->start_date = "-1";
        //     $this->end_date = "-1";
        // }
