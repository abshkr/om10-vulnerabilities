...
class SiteBal extends CommonClass
{
    ...
    public function read_no_base_change()
    {
        ...
        FROM 
            ...
            (
                SELECT 
                    SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_AVL/1000.0, TRANBASE.TRSB_AVL)) RCPT_AVL, 
                    SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_CVL/1000.0, TRANBASE.TRSB_CVL)) RCPT_CVL, 
                    TRANBASE.TRSB_BS, 
            ...
            (
                SELECT 
                    SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_AVL/1000.0, TRANBASE.TRSB_AVL)) TRSF_IN_AVL, 
                    SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_CVL/1000.0, TRANBASE.TRSB_CVL)) TRSF_IN_CVL, 
                    TRANBASE.TRSB_BS, 
                    TRANBASE.TRSB_TK_TANKDEPO,
                    TRANBASE.TRSB_TK_TANKCODE
                FROM 
            ...
            (
                SELECT 
                    SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_AVL/1000.0, TRANBASE.TRSB_AVL)) TRSF_OUT_AVL, 
                    SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_CVL/1000.0, TRANBASE.TRSB_CVL)) TRSF_OUT_CVL, 
                    TRANBASE.TRSB_BS, 
                    TRANBASE.TRSB_TK_TANKDEPO,
                    TRANBASE.TRSB_TK_TANKCODE
                FROM 
            ...
            (
                SELECT 
                    SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_AVL/1000.0, TRANBASE.TRSB_AVL)) RACK_AVL, 
                    SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_CVL/1000.0, TRANBASE.TRSB_CVL)) RACK_CVL, 
                    TRANBASE.TRSB_BS, 
                    TRANBASE.TRSB_TK_TANKDEPO, 
                    TRANBASE.TRSB_TK_TANKCODE
                FROM 
    ...
    FROM TERMINAL, CLOSEOUTS, CLOSEOUT_TANK, TANKS, BASE_PRODS,
        (SELECT SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_AVL/1000.0, TRANBASE.TRSB_AVL)) RCPT_AVL, SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_CVL/1000.0, TRANBASE.TRSB_CVL)) RCPT_CVL, TRANBASE.TRSB_TK_TANKCODE
        ...
        (SELECT SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_AVL/1000.0, TRANBASE.TRSB_AVL)) TRSF_IN_AVL, SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_CVL/1000.0, TRANBASE.TRSB_CVL)) TRSF_IN_CVL, TRANBASE.TRSB_TK_TANKCODE
        FROM TRANSFERS, TRANSACTIONS, TRANBASE
        WHERE TRANBASE.TRSB_ID_TRSF_ID = TRANSFERS.TRSF_ID
            AND TRANSFERS.TRSFTRID_TRSA_ID = TRANSACTIONS.TRSA_ID
            AND TRANSACTIONS.TRSA_IOTYPE = -1 AND TRANSACTIONS.TRSA_CLASS = 1
        ...
        (SELECT SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_AVL/1000.0, TRANBASE.TRSB_AVL)) TRSF_OUT_AVL, SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_CVL/1000.0, TRANBASE.TRSB_CVL)) TRSF_OUT_CVL, TRANBASE.TRSB_TK_TANKCODE
            FROM TRANBASE
        ...
        (SELECT SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_AVL/1000.0, TRANBASE.TRSB_AVL)) RACK_AVL, SUM(DECODE(TRANBASE.TRSB_UNT, 34, TRANBASE.TRSB_CVL/1000.0, TRANBASE.TRSB_CVL)) RACK_CVL, TRANBASE.TRSB_TK_TANKCODE
        FROM TRANSFERS, TRANSACTIONS, TRANBASE
        WHERE TRANBASE.TRSB_ID_TRSF_ID = TRANSFERS.TRSF_ID
            AND TRANSFERS.TRSFTRID_TRSA_ID = TRANSACTIONS.TRSA_ID
            AND TRANSACTIONS.TRSA_IOTYPE = 1 AND TRANSACTIONS.TRSA_CLASS = 0
