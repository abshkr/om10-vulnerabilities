...
class SiteBal extends CommonClass
{
    ...
    public function read()
    {
        ...
        NVL(TANKS.TANK_TRF_VOL, 0.0)*NVL(TANKS.TANK_RPTVCF, 1) + NVL(RACK_CVL, 0) - NVL(TRSF_OUT_CVL, 0) TRANSFERVOL,
        (NVL(TANKS.TANK_LTR_CLOSE, 0.0)*NVL(TANKS.TANK_RPTVCFCLOSE, 1) + NVL(TANKS.TANK_RCPT_VOL, 0.0)*NVL(TANKS.TANK_RPTVCF, 1) - NVL(TRSF_IN_CVL, 0) +  NVL(TRSF_IN_CVL, 0)) -  (NVL(TANKS.TANK_TRF_VOL, 0.0)*NVL(TANKS.TANK_RPTVCF, 1) + NVL(RACK_CVL, 0) - NVL(TRSF_OUT_CVL, 0)) - (NVL(TRSF_OUT_CVL, 0)) BOOKBALANCE,
        ...
        ((NVL(TANKS.TANK_LTR_CLOSE, 0.0)*NVL(TANKS.TANK_RPTVCFCLOSE, 1) + NVL(TANKS.TANK_RCPT_VOL, 0.0)*NVL(TANKS.TANK_RPTVCF, 1) - NVL(TRSF_IN_CVL, 0) +  NVL(TRSF_IN_CVL, 0)) -  (NVL(TANKS.TANK_TRF_VOL, 0.0)*NVL(TANKS.TANK_RPTVCF, 1) + NVL(RACK_CVL, 0) - NVL(TRSF_OUT_CVL, 0)) - (NVL(TRSF_OUT_CVL, 0))) - (NVL(TANKS.TANK_LTR_CLOSE, 0.0)*NVL(TANKS.TANK_RPTVCFCLOSE, 1) + NVL(TANKS.TANK_RCPT_VOL, 0.0)*NVL(TANKS.TANK_RPTVCF, 1) - NVL(TRSF_IN_CVL, 0) +  NVL(TRSF_IN_CVL, 0)) + (NVL(TANKS.TANK_RCPT_VOL, 0.0)*NVL(TANKS.TANK_RPTVCF, 1) - NVL(TRSF_IN_CVL, 0)) + (NVL(TRSF_IN_CVL, 0)) GAINLOSS
