...
include_once './service/auth_server_service.php';
...
$serv = new AuthServerService($db, "LDAP");
$array = $serv->auth_by_ldap_servers($object);
$user_id = $object->user;
$object->user = $array["USER_DETAIL"]["USER_CODE"];
...
if ($array['MSG_CODE'] === "0") {
    ...
    $login_result['email'] = "";
    $login_result['displayName'] = $array['USER_DETAIL']['USER_NAME']; //$object->user;
    ...
    $login_result['auth_mode'] = "LDAP";
    // $login_result['arrays'] = $array;
