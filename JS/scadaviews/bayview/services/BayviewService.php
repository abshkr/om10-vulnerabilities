	...
	*/
	...
	public function afterRetrieve( $data )
	{
		if ( $data->zip_on == 1 )
		{
			...
			$decompress_data = gzuncompress( $decode_data );
			$data->data = $decompress_data;
			$data->zip_on = 0;
		}
		return $data;
	}
				...
				*/
				if ( $cmpt_item['prod_unit'] == 17 )
				{
					...
					if ( $bay_item['bay_load'][0]['load_status_id'] == 'L' )
					{
						...
						if ( isset($cmpt2armmass[$cmpt_item['cmpt_no']]) && $cmpt2armmass[$cmpt_item['cmpt_no']]>0 )
						{
				...
				else if ( $cmpt_item['prod_unit'] == 11 )
				{
					...
					if ( $bay_item['bay_load'][0]['load_status_id'] == 'L' )
					{
						...
						if ( isset($cmpt2armstd[$cmpt_item['cmpt_no']]) && $cmpt2armstd[$cmpt_item['cmpt_no']]>0 )
						{
				...
				else
				{
					...
					if ( $bay_item['bay_load'][0]['load_status_id'] == 'L' )
					{
						...
						if ( isset($cmpt2armamb[$cmpt_item['cmpt_no']]) && $cmpt2armamb[$cmpt_item['cmpt_no']]>0 )
						{
