...
alter table TANKS add TANK_HH_STATE NUMBER(1) default 0;
alter table TANKS add TANK_H_LEVEL FLOAT;
alter table TANKS add TANK_H_STATE NUMBER(1) default 0;
alter table TANKS add TANK_L_LEVEL FLOAT;
alter table TANKS add TANK_L_STATE NUMBER(1) default 0;
alter table TANKS add TANK_LL_LEVEL FLOAT;
alter table TANKS add TANK_LL_STATE NUMBER(1) default 0;
alter table TANKS add TANK_UH_LEVEL FLOAT;
alter table TANKS add TANK_UH_STATE NUMBER(1) default 0;
alter table TANKS add TANK_UL_LEVEL FLOAT;
alter table TANKS add TANK_UL_STATE NUMBER(1) default 0;
