 ...
 * of this value object you may modify the generated sub-class of this class - CloseoutsFolios.as.
 */
...
[ExcludeClass]
public class _Super_CloseoutsFolios extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("CloseoutsFolios") == null)
            {
                flash.net.registerClassAlias("CloseoutsFolios", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CloseoutsFoliosEntityMetadata;
    ...
    private var _internal_closeout_folio : String;
    ...
    public function _Super_CloseoutsFolios()
    {
        _model = new _CloseoutsFoliosEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "closeout_folio", model_internal::setterListenerCloseout_folio));
    ...
    [Bindable(event="propertyChange")]
    public function get closeout_folio() : String
    {
        return _internal_closeout_folio;
    }
    ...
    public function set closeout_folio(value:String) : void
    {
        var oldValue:String = _internal_closeout_folio;
        if (oldValue !== value)
        {
            _internal_closeout_folio = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "closeout_folio", oldValue, _internal_closeout_folio));
        }
    }
    ...
    model_internal function setterListenerCloseout_folio(value:flash.events.Event):void
    {
        _model.invalidateDependentOnCloseout_folio();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.closeout_folioIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_closeout_folioValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CloseoutsFoliosEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CloseoutsFoliosEntityMetadata) : void
    {
        var oldValue : _CloseoutsFoliosEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfCloseout_folio : Array = null;
    model_internal var _doValidationLastValOfCloseout_folio : String;

    model_internal function _doValidationForCloseout_folio(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfCloseout_folio != null && model_internal::_doValidationLastValOfCloseout_folio == value)
           return model_internal::_doValidationCacheOfCloseout_folio ;

        _model.model_internal::_closeout_folioIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isCloseout_folioAvailable && _internal_closeout_folio == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "closeout_folio is required"));
        }

        model_internal::_doValidationCacheOfCloseout_folio = validationFailures;
        model_internal::_doValidationLastValOfCloseout_folio = value;
