 ...
 * of this value object you may modify the generated sub-class of this class - CompanyLookup.as.
 */
...
[ExcludeClass]
public class _Super_CompanyLookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("CompanyLookup") == null)
            {
                flash.net.registerClassAlias("CompanyLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CompanyLookupEntityMetadata;
    ...
    public function _Super_CompanyLookup()
    {
        _model = new _CompanyLookupEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CompanyLookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CompanyLookupEntityMetadata) : void
    {
        var oldValue : _CompanyLookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
