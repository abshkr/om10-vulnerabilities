 ...
 * of this value object you may modify the generated sub-class of this class - ScheduleTankersLookup.as.
 */
...
[ExcludeClass]
public class _Super_ScheduleTankersLookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("ScheduleTankersLookup") == null)
            {
                flash.net.registerClassAlias("ScheduleTankersLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _ScheduleTankersLookupEntityMetadata;
    ...
    public function _Super_ScheduleTankersLookup()
    {
        _model = new _ScheduleTankersLookupEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ScheduleTankersLookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ScheduleTankersLookupEntityMetadata) : void
    {
        var oldValue : _ScheduleTankersLookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
