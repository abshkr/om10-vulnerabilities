 ...
 * of this value object you may modify the generated sub-class of this class - CompaniesLookup.as.
 */
...
[ExcludeClass]
public class _Super_CompaniesLookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("PersonnelLookup") == null)
            {
                flash.net.registerClassAlias("PersonnelLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CompaniesLookupEntityMetadata;
    ...
    public function _Super_CompaniesLookup()
    {
        _model = new _CompaniesLookupEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CompaniesLookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CompaniesLookupEntityMetadata) : void
    {
        var oldValue : _CompaniesLookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
