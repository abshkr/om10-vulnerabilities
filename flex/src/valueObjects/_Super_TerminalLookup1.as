 ...
 * of this value object you may modify the generated sub-class of this class - TerminalLookup1.as.
 */
...
[ExcludeClass]
public class _Super_TerminalLookup1 extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("TerminalLookup") == null)
            {
                flash.net.registerClassAlias("TerminalLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _TerminalLookup1EntityMetadata;
    ...
    public function _Super_TerminalLookup1()
    {
        _model = new _TerminalLookup1EntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TerminalLookup1EntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TerminalLookup1EntityMetadata) : void
    {
        var oldValue : _TerminalLookup1EntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
