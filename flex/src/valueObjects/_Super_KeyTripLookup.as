 ...
 * of this value object you may modify the generated sub-class of this class - KeyTripLookup.as.
 */
...
[ExcludeClass]
public class _Super_KeyTripLookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("KeyTripLookup") == null)
            {
                flash.net.registerClassAlias("KeyTripLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _KeyTripLookupEntityMetadata;
    ...
    public function _Super_KeyTripLookup()
    {
        _model = new _KeyTripLookupEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _KeyTripLookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _KeyTripLookupEntityMetadata) : void
    {
        var oldValue : _KeyTripLookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
