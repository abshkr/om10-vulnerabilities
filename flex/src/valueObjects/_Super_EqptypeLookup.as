 ...
 * of this value object you may modify the generated sub-class of this class - EqptypeLookup.as.
 */
...
[ExcludeClass]
public class _Super_EqptypeLookup extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("EqptypeLookup") == null)
            {
                flash.net.registerClassAlias("EqptypeLookup", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _EqptypeLookupEntityMetadata;
    ...
    public function _Super_EqptypeLookup()
    {
        _model = new _EqptypeLookupEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _EqptypeLookupEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _EqptypeLookupEntityMetadata) : void
    {
        var oldValue : _EqptypeLookupEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
