...
{ 
	...
	if (curViewDetailState <= 1 || curViewDetailState == 2 || curViewDetailState > 10) // view records
  {
    ...
    if(curPrivilage>=5 && (area!="-1")&&(area!=""))
    {
      ...
      newPage += btnLocation_HTML("justChaneMyLocation('area.php'); ", otherText["back_to_areaPg"]);
    }
...
function displayAddNewGateFrm()
{
  ...
  addFrmhtml +=  			 btnLocation_HTML("justChaneMyLocation('gate.php?op=-1&pg=-1&area="+area+"'); ", otherText["back_to_gate_list"]);
  addFrmhtml +="			  <br>\n";	    
  addFrmhtml +="			<\/div>\n";
  addFrmhtml +="<br>";
  addFrmhtml +="		</td>\n";
 ...
 addFrmhtml +="                                                                                                                        </td>\n";
  ...
  addFrmhtml +="                                <input type=\"hidden\" name='area' value='" + area + "'>\n";  
  addFrmhtml +="															</td>\n";  	    
