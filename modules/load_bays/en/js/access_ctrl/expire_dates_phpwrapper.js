...
*/
  ...
  ModFrmhtml += "      <form name=\"addNew\" method =\"get\" id=\"addNew\" onsubmit=\"return submitmyform(this)\">\n";
...
function backToBtn_HTML ()
{
  var btn_HTML = "";
   ...
   btn_HTML +="<a href=\"javascript:justChaneMyLocation('?'); \">Back To Expiry Dates Page</a>";
   btn_HTML +="                                 </div><br>\n";
   btn_HTML +="             <td>\n ";
   btn_HTML +="         </tr> \n";
   return btn_HTML;
...
function viewAllBtn_HTML ()
{
  var btn_HTML = "";
   ...
   btn_HTML +="<a href=\"javascript:justChaneMyLocation('?'); \">View All</a>";
   btn_HTML +="                                 </div><br>\n";
   btn_HTML +="             <td>\n ";
   btn_HTML +="         </tr> \n";
   return btn_HTML;
