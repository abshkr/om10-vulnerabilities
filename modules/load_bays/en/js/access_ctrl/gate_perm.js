...
function displayAddNewPrmssnFrm()
{
  ...
  addFrmhtml += "      <form name=\"addNew\" method =\"POST\" id=\"addNew\" action=\"gate_perm.cgi\" onsubmit=\"return checkPermName(this);\">\n";
...
addFrmhtml += "   <tr> \n";
  ...
  addFrmhtml += "      <form name=\"addNew\" method =\"get\" id=\"addNew\" action=\"gate_perm.cgi\" onsubmit=\"return submitmyform(this)\">\n";
  addFrmhtml +=          preqstr_field ();
  addFrmhtml +="						<tr>\n";
  addFrmhtml +="									<td class=\"infotext\" width=\"100%\">\n";
  addFrmhtml +="										<table width=\"100%\">\n";
...
function backToBtn_HTML ()
{
  var btn_HTML = "";
   ...
   btn_HTML += btnLocation_HTML("justChaneMyLocation('gate_perm.cgi'); ", otherText["btn_bakto_prmssnPg"]);
   btn_HTML +="                                 </div><br>\n";
   btn_HTML +="             <td>\n ";
   btn_HTML +="         </tr> \n";
   return btn_HTML;
...
function addNewBtn_HTML ()
{
  var btn_HTML = "";
   ...
   if(priv>=7)
   {
    btn_HTML += btnLocation_HTML("justChaneMyLocation('gate_perm.cgi?op=7'); ", otherText["btn_addNew_prmssn"]);
   }
