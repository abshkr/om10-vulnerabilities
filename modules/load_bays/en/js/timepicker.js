  ...
  function refreshTimePicker(mode, tm) {
    ...
    for (i=0;i<12;i++) {
      ...
      for (j=0;j<4;j++) {
        ...
        sHTML+="<td " + bgcolor + "width=57 style='cursor:pointer;font-family:verdana;font-size:11px;' onmouseover='this.style.backgroundColor=\"#66CCFF\"' onmouseout='this.style.backgroundColor=\"\"' onclick='setTimePicker(\""+ hr + ":" + padZero(j*15) + "&nbsp;" + suffix 
