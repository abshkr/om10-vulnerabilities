...
function displayAddNewMtrDvc()
{
  ...
  addFrmhtml += "      <form name=\"addNew\" method =\"get\" id=\"addNew\" action=\"meter_dev.php\" onsubmit=\"return validateAndSubmit(this)\">\n";
...
function backToBtn_HTML ()
{
  var btn_HTML = "";
   ...
   btn_HTML += btnLocation_HTML("justChaneMyLocation('meter_dev.php'); ", otherText["btn_bakto_mtrdvcPg"]);
   btn_HTML +="                                 </div><br>\n";
   btn_HTML +="             <td>\n ";
   btn_HTML +="         </tr> \n";
   return btn_HTML;
...
function addNewBtn_HTML ()
{
  var btn_HTML = "";
   ...
   if(priv>=7)
   {
    btn_HTML += btnLocation_HTML("justChaneMyLocation('meter_dev.php?op="+opValues["enterAdd"]+"'); ", otherText["btn_addNew_mtrdvc"]);
   }
