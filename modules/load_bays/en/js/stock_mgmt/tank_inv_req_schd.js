...
function backToBtn_HTML ()
{
  var btn_HTML = "";
   ...
   btn_HTML += btnLocation_HTML("justChaneMyLocation('tank_inv_req_schd.cgi'); ", otherText["btn_bakto_eqpTp"]);
   btn_HTML +="                                 </div><br>\n";
   btn_HTML +="             <td>\n ";
   btn_HTML +="         </tr> \n";
   return btn_HTML;
...
function addNewBtn_HTML ()
{
  var btn_HTML = "";
   ...
   btn_HTML +="             <td align=\"center\">\n ";
   btn_HTML +="                                 <div class=\"button\">\n";
   btn_HTML += btnLocation_HTML("justChaneMyLocation('tank_inv_req_schd_tank.cgi?term="+terminal[1][0]+"'); ", otherText["tk_selctn"]);
   if(priv>=7)
   {
		btn_HTML += btnLocation_HTML("justChaneMyLocation('/cgi-bin/en/stck_mgmt/tank_inv_req_schd.cgi?op="+opValues["enterAdd"]+"'); ", otherText["btn_addNew_schReq"]);
	}
   btn_HTML +="                                 </div><br>\n";
   btn_HTML +="             <td>\n ";
   btn_HTML +="         </tr> \n";
...
function local_HeadrHTML(newPage)
{
  ...
  newPage +="     document.location.href=\"tank_inv_req_schd_tank.cgi?term=\"+myterm+\"\";\n";
  newPage +="   }\n";
  newPage +="   else\n";
  newPage += "  {\n";
  newPage += "    eval(\"document.select_action_\"+frmNum+\".submit();\");\n";
