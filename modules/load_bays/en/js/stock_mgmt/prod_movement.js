// @(#) $Id: prod_movement.js,v 1.15 2006/09/25 05:01:44 abs Exp $";
...
addOwnerButton()
{
	...
	if(priv >= 7)
	{
		btn_HTML += btnLocation_HTML("justChaneMyLocation('prod_movement.cgi?op=702'); ",
				buttonsTxt["addOwner"]);
	}
	return btn_HTML;
}
...
{
	var btn_HTML = "";
	var t = "justChaneMyLocation('prod_movement.cgi?op=206&h_PMV_NUMBER=";
...
{
	var btn_HTML = "";
	var t = "justChaneMyLocation('prod_movement.cgi?op=207&h_PMV_NUMBER=";
	t += h_PMV_NUMBER +"&pmvDepot="+pmvDepot+"'); ";
...
{
	var btn_HTML = "";
	var t = "justChaneMyLocation('prod_movement.cgi?op=208&h_PMV_NUMBER=";
	t += h_PMV_NUMBER +"&pmvDepot="+pmvDepot+"'); ";
...
{
	var btn_HTML = "";
	btn_HTML += btnLocation_HTML("justChaneMyLocation('prod_movement.cgi?op=1'); ",
			buttonsTxt["Back"]);
	return btn_HTML;
}
/*============================================================================*/
...
{
	var btn_HTML = "";
	var args = "justChaneMyLocation('prod_movement.cgi?op=1&pmvDepot=";
	args += pmvDepot + "'); ";
...
addProductMovementButton ()
{
	...
	var args = "justChaneMyLocation('prod_movement.cgi?op=102&pmvDepot=";
	args += pmvDepot + "'); ";
	if(priv >= 7)
	{
...
viewPmvPageBody( curAuth )
{
  ...
  {
      	bdyLines +=nextPage_long(pagesTotal, pg,"prod_movement.cgi", "pg");
  }
	return( bdyLines );
}
/*============================================================================*/
...
productMovementDetailsBody( curAuth )
{
	...
	detsFrmhtml += " action=\"prod_movement.cgi\">\n";
	...
	detsFrmhtml += " src=\"prod_movement.cgi?op=108";
...
addProductMovementBody( curAuth )
{
  ...
  addFrmhtml += " action=\"prod_movement.cgi\" onsubmit=\"return validateAndSubmit(this)\">\n";
