...
function displayDelivLocList(curPrivilage,curColumnToSort)
{
	...
	dispFrm += makespace("\t", indent) + nextPage(pagesTotal_3, pg_3, "delivery.cgi", "pg_3");
	...
	if (is_search_on == 1)
	{
		...
		dispFrm += makespace("\t", indent+1) + "<form name=\"list_deliv_loc\" method=\"get\" id=\"list_deliv_loc\" action=\"delivery.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
function displayAssignDelivLocForm()
{
	...
	assnFrm += makespace("\t", indent+1) + "<form name=\"assign_delvloc_frm\" method=\"get\" id=\"assign_delvloc_frm\" action=\"delivery.cgi\" >\n";
...
function displayModifyDelivLocForm ()
{
	...
	updFrm += makespace("\t", indent+1) + "<form name=\"edit_delivlocs\" method=\"post\" id=\"edit_delivlocs\" action=\"delivery.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
function displayInsertDelivLocForm ()
{
	...
	addFrm += makespace("\t", indent+1) + "<form name=\"add_delivlocs\" method=\"post\" id=\"add_delivlocs\" action=\"delivery.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
//	updFrm += makespace("\t", indent+2) + btnLocation_HTML("void(printSpecial()); ", commBtnText["Print"]);
	updFrm += makespace("\t", indent+2) + btnLocation_HTML("justChaneMyLocation('delivery.cgi?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&delivCd='+delivCd+'&op='+" + opValues["viewAddress"] + "); ", otherText["btn_bakto_delivAddrPg"]);
...
//	updFrm += makespace("\t", indent+1) + "<div id=\"printReady\">\n";  /* Start of Print Area */
	...
	updFrm += makespace("\t", indent+2) + "<form name=\"edit_address\" method=\"post\" id=\"edit_address\" action=\"delivery.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
//	addFrm += makespace("\t", indent+2) + btnLocation_HTML("void(printSpecial()); ", commBtnText["Print"]);
	...
	{
		addFrm += makespace("\t", indent+2) + btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&delivCd='+delivCd+'&op='+" + prevOp + "); ", otherText["btn_bakto_delivLocsAdd"]);
	}
	if (prevOp == opValues["modifyDelivLocForm"])
	{
		addFrm += makespace("\t", indent+2) + btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&delivCd='+delivCd+'&op='+" + prevOp + "); ", otherText["btn_bakto_delivLocsUpd"]);
	}
...
//	addFrm += makespace("\t", indent+1) + "<div id=\"printReady\">\n";  /* Start of Print Area */
	...
	addFrm += makespace("\t", indent+2) + "<form name=\"add_address\" method=\"post\" id=\"add_address\" action=\"delivery.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
function btnGroupDelivLoc_HTML ()
{
	...
	if(priv>=7)
	{
		btn_HTML += btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["insertDelivLocForm"] + "'); ", otherText["btn_addNew_delivLocs"]);
	}
	if(priv>=5 && is_search_on != 1)
	{
		btn_HTML += btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on=1&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["listDelivLoc"] + "'); ", otherText["btn_search_delivLocs"]);
	}
	if(priv>=5 && is_search_on == 1)
	{
		btn_HTML += btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on=0&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["listDelivLoc"] + "'); ", otherText["btn_view_delivLocs"]);
	}
...
function btnGroupDelivLocDetails_HTML ()
{
	...
	btn_HTML += btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["listDelivLoc"] + "'); ", otherText["btn_bakto_delivLocsPg"]);
...
function btnGroupAssignDelivLoc_HTML ()
{
	...
	btn_HTML += btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&op=" + opValues["listDelivLoc"] + "'); ", otherText["btn_bakto_delivLocsPg"]);
//	btn_HTML += btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["listDelivLoc"] + "'); ", otherText["btn_bakto_delivLocsPg"]);
...
function btnGroupModifyDelivLoc_HTML ()
{
	...
	if (priv >= 7)
	{
		btn_HTML += "&nbsp; " + btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&prevOp=" + opValues["modifyDelivLocForm"] + "&op=" + opValues["insertAddressForm"] + "&delivCd='+delivCd); ", otherText["btn_addNew_delivAddr"]);
	}
...
function btnGroupInsertDelivLoc_HTML ()
{
	...
	if (priv >= 7)
	{
		btn_HTML += "&nbsp; " + btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&prevOp=" + opValues["insertDelivLocForm"] + "&op=" + opValues["insertAddressForm"] + "&delivCd='+delivCd); ", otherText["btn_addNew_delivAddr"]);
	}
...
function backToBtnAddr_HTML ()
{
	...
	{
		btn_HTML += "&nbsp; " + btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&op=" + opValues["modifyAddressForm"] + "&delivCd='+delivCd); ", commBtnText["Modify"]);
	}

//	btn_HTML += btnLocation_HTML("void(printSpecial()); ", commBtnText["Print"]);

	btn_HTML += btnLocation_HTML("justChaneMyLocation('delivery.cgi?is_search_on='+is_search_on+'&pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&delivCd='+delivCd); ", otherText["btn_bakto_delivLocsPg"]);
