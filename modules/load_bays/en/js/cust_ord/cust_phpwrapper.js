...
function displayAddNewFrm()
{
  ...
  addFrmhtml += "      <form name=\"addNew\" method =\"get\" id=\"addNew\" action=\"cust.php\" onsubmit=\"return submitmyform(this)\">\n";
...
function displayDelvrLocation(curPrivilage,curColumnToSort)
{
  ...
  delvrLocHtml +=nextPage(pagesTotal_3, pg_3, "cust.php", "pg_3");
  delvrLocHtml += "<tr> \n";
...
function backToBtn_HTML ()
{
   ...
   btn_HTML += btnLocation_HTML("justChaneMyLocation('cust.php?suppCd='+suppCd); ", otherText["back_to_customers"]);
   btn_HTML +="                                 &nbsp;\n";
...
function addNewBtn_HTML ()
{
  var btn_HTML = "";
   ...
   btn_HTML +="                                 <div class=\"button\">\n";
    ...
    btn_HTML += btnLocation_HTML("if(cmpy_jslst.length==2) suppCd=cmpy_jslst[1][0]; if (checkSupplier()) justChaneMyLocation('cust.php?op="+opValues["insertCustomerForm"]+"&suppCd='+suppCd); ", otherText["add_new_cust"]);
//    btn_HTML += "&nbsp; "+ btnLocation_HTML("void(printSpecial()); ", "Print");
...
function local_HeadrHTML( newPage )
{
	...
	newPage += "  {\n";
	newPage +="     document.location.href=\"allocations.php?op=0&pg=1&type=3&cmpy=\"+accNum+\"&supp="+suppCd+"\";\n";
	newPage +="   }\n";
  
	newPage +=    "else if(myselectedvalue==\"3\")\n";
	newPage += "  {\n";
	newPage +="     document.location.href=\"delivery_loc.php?op="+opValues["listDelivLoc"]+"&pg=1&cmpyCd=\"+accNum+\"&suppCd="+suppCd+"&custAcc=\"+custAcct+\"\";\n";
  
	newPage +="   }\n";
  
	newPage +=    "else if(myselectedvalue==\"4\")\n";
	newPage += "  {\n";
	newPage +="     document.location.href=\"cust_ledger.php?op="+opValues["listCustLedger"]+"&pg=1&cmpyCd=\"+accNum+\"&suppCd="+suppCd+"&custAcc=\"+custAcct+\"\";\n";
  
	newPage +="   }\n";
 
	newPage +=    "else if(myselectedvalue==\"9\")\n";
	newPage += "  {\n";
	newPage +="     document.location.href=\"order_ent_maint.php?termCd=-1&op="+opValues["listOrder"]+"&pg=1&cmpyCd=\"+accNum+\"&suppCd="+suppCd+"&custAcc=\"+custAcct+\"\";\n";
  
	newPage +="   }\n";

	newPage +=    "else if(myselectedvalue==\"10\")\n";
	newPage += "  {\n";
	newPage +="     document.location.href=\"cust_invoice.php?op="+opValues["listCustInvoice"]+"&pg=1&cmpyCd=\"+accNum+\"&suppCd="+suppCd+"&custAcc=\"+custAcct+\"\";\n";
  
	newPage +="   }\n";
 
	newPage +=    "else if(myselectedvalue==\""+opValues["baseAccountDetail"]+"\")\n";
	newPage += "  {\n";
	newPage +="     document.location.href=\"account_details.php?termCd=-1&op="+opValues["listAccountDetail"]+"&cmpyCd=\"+accNum+\"&suppCd="+suppCd+"&custAcc=\"+custAcct+\"\";\n";
  ...
  //newPage +="       document.location.href=\"del_cust.php?op=8&preqstr=\"+myCurQstring;\n";
	newPage += "    }\n";
	newPage += "    else\n";
	newPage += "    {\n";
	...
	newPage +="       document.location.href=\"del_cust.php?op=11&preqstr=\"+myCurQstring;\n";
	newPage += "    }\n";  
	newPage +="   }\n";
	newPage +="   else\n";
	newPage += "  {\n";
