...
//	dispFrm += makespace("\t", indent+1) + "<div id=\"printReady\"> \n";
	...
	dispFrm += makespace("\t", indent) + nextPage(pagesTotal_3, pg_3, "cust_invoice.php", "pg_3");
...
function displayordOrderInvoiceHeader(type)
{
	...
	dispFrm += makespace("\t", indent) + "<tr>\n";
	dispFrm += makespace("\t", indent) + "<td>\n";
	dispFrm += makespace("\t", indent+1) + "<form name=\"list_ord_invoice\" method=\"get\" id=\"list_ord_invoice\" action=\"cust_invoice.php\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
//	addFrm += makespace("\t", indent+3) + "<div id=\"printReady\">\n";
	...
	addFrm += makespace("\t", indent+1) + "<form name=\"gen_invoice\" method=\"get\" id=\"gen_invoice\" action=\"cust_invoice.php\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
//	addFrm += makespace("\t", indent+3) + "<div id=\"printReady\">\n";
	...
	addFrm += makespace("\t", indent+1) + "<form name=\"add_payment\" method=\"get\" id=\"add_payment\" action=\"cust_invoice.php\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
function btnGroupCustInvoice_HTML ()
{
	...
	if(priv>=7)
	{
		btn_HTML += btnLocation_HTML("justChaneMyLocation('cust_invoice.php?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["insertPaymentForm"] + "'); ", otherText["btn_addNew_payment"]);

		btn_HTML += btnLocation_HTML("justChaneMyLocation('cust_invoice.php?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["insertCustInvoiceForm"] + "'); ", otherText["btn_addNew_custInvoice"]);
	}
...
//	btn_HTML += btnLocation_HTML("void(printSpecial()); ", commBtnText["Print"]);
	...
	btn_HTML += btnLocation_HTML("justChaneMyLocation('cust_invoice.php?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["listCustInvoice"] + "'); ", otherText["btn_bakto_custInvoicePg"]);
