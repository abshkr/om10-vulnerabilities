...
if ( 'cn' == js_lang)
{
	...
	var column_headers = [
			"供应商", "客户", "订单", "参考号", "配送地点", "配送日期", "订单状态", "已批准?", "操作员", "订单来源"
	];
	...
	otherText["btn_bakto_orderPg"] =  "返回订单管理";

	otherText["btn_next_page"] =  "下一页";
	otherText["btn_prev_page"] =  "上一页";
	otherText["btn_search_go"] =  "开始查找 ...";

	otherText["tab_depot_ordstat"] = "发油油库和订单状态信息";

	otherText["pgTitle_order"] =  "客户订单管理, 订单管理";
	otherText["pgTitle_orderUpd"] =  "客户订单管理, 订单管理, 修改";
	otherText["pgTitle_orderAdd"] =  "客户订单管理, 订单管理, 新增";
	otherText["pgTitle_orderDel"] =  "客户订单管理, 订单管理, 删除";

	otherText["pgHead_order"] =  "订单管理";
...
//	var dateFormat = "dd-NNN-yyyy";
	...
	l_opInf[10128]= "成功删除了一个订单!";
	l_opInf[10127]= "成功新增了一个订单!";
	l_opInf[10126]= "成功修改了一个订单!";

	l_opInf[10138]= "删除订单失败!";
	l_opInf[10137]= "新增订单失败!";
	l_opInf[10136]= "修改订单失败!";
