...
function displayModifyCategoryForm ()
{
	...
	updFrm += makespace("\t", indent+1) + "<form name=\"edit_category\" method=\"get\" id=\"edit_category\" action=\"category.php\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
//	addFrm += makespace("\t", indent+3) + "<div id=\"printReady\">\n";
	...
	addFrm += makespace("\t", indent+1) + "<form name=\"add_category\" method=\"get\" id=\"add_category\" action=\"category.php\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
function btnGroupCategory_HTML ()
{
	...
	if(priv>=7)
	{
		btn_HTML += btnLocation_HTML("justChaneMyLocation('category.php?pg_3='+pg_3+'&pg='+pg+'&op=" + opValues["insertCategoryForm"] + "'); ", otherText["btn_addNew_category"]);
	}
...
function btnGroupBackCategory_HTML ()
{
	...
	btn_HTML += btnLocation_HTML("justChaneMyLocation('category.php'); ", otherText["btn_bakto_categoryPg"]);
