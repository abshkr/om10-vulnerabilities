...
//	dispFrm += makespace("\t", indent) + nextPage(pagesTotal_3, pg_3, "account_details.cgi", "pg_3");
...
//	updFrm += makespace("\t", indent+3) + "<div id=\"printReady\">\n";
	...
	updFrm += makespace("\t", indent+1) + "<form name=\"edit_acctdet\" method=\"get\" id=\"edit_acctdet\" action=\"account_details.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
//	addFrm += makespace("\t", indent+3) + "<div id=\"printReady\">\n";
	...
	addFrm += makespace("\t", indent+1) + "<form name=\"add_payment\" method=\"get\" id=\"add_payment\" action=\"account_details.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
//	updFrm += makespace("\t", indent+1) + "<div id=\"printReady\">\n";
	...
	updFrm += makespace("\t", indent+1) + "<form name=\"edit_category\" method=\"get\" id=\"edit_category\" action=\"account_details.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
//	addFrm += makespace("\t", indent+3) + "<div id=\"printReady\">\n";
	...
	addFrm += makespace("\t", indent+1) + "<form name=\"add_category\" method=\"get\" id=\"add_category\" action=\"account_details.cgi\" onsubmit=\"return Validator.Validate(this,1);\">\n";
...
function btnGroupAcctDetail_HTML ()
{
	...
	if(priv>=7)
	{
		btn_HTML += btnLocation_HTML("justChaneMyLocation('account_details.cgi?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["insertAcctDetailForm"] + "'); ", otherText["btn_addNew_acctDetail"]);
	}
	if(priv>=6)
	{
		btn_HTML += btnLocation_HTML("justChaneMyLocation('account_details.cgi?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["modifyAcctDetailForm"] + "'); ", otherText["btn_upd_acctDetail"]);
	}
...
function btnGroupAcctDetailDetails_HTML ()
{
	...
	btn_HTML += btnLocation_HTML("justChaneMyLocation('account_details.cgi?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&op=" + opValues["listAcctDetail"] + "'); ", otherText["btn_bakto_acctDetailPg"]);
...
function btnGroupModifyAcctDetail_HTML ()
{
	...
	if (priv >= 7)
	{
		btn_HTML += "&nbsp; " + btnLocation_HTML("justChaneMyLocation('account_details.cgi?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&prevOp=" + opValues["modifyAcctDetailForm"] + "&op=" + opValues["insertCategoryForm"] + "'); ", otherText["btn_addNew_category"]);
	}
	if (priv >= 6)
	{
		btn_HTML += "&nbsp; " + btnLocation_HTML("justChaneMyLocation('account_details.cgi?pg_3='+pg_3+'&pg='+pg+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc+'&prevOp=" + opValues["modifyAcctDetailForm"] + "&op=" + opValues["modifyCategoryForm"] + "&frm_catcode="+ frm_category +"'); ", otherText["btn_upd_category"]);
	}
...
//	btn_HTML += btnLocation_HTML("void(printSpecial()); ", commBtnText["Print"]);
	...
	btn_HTML += btnLocation_HTML("justChaneMyLocation('account_details.cgi?pg_3='+pg_3+'&pg='+pg+'&op='+prevOp+'&suppCd='+suppCd+'&cmpyCd='+cmpyCd+'&custAcc='+custAcc); ", otherText["btn_bakto_acctDetailPg"]);
