...
cp -r client/build/* server/api/ server/amfservices/ server/phpwrapper/ modules/load_bays/en/ modules/load_bays/images/ modules/load_bays/*.js tmp/$OM_VER/frontend/